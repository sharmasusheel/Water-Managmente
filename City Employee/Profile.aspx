<%@ page language="C#" autoeventwireup="true" inherits="City_Employee_Profile, App_Web_lgwd3hcu" %>
...
<body style="background-color:White">
    ...
    <div align="left" style="position:fixed;float:left;height:100%;width:200px;border-bottom:5px solid Black;border-right:5px solid Black;border-left:5px solid Black;border-top:5px solid Black; background-color: Green">
        ...
        <tr><td><asp:LinkButton ID="lnk1" runat="server" ForeColor="White" 
                onclick="lnk1_Click">General</asp:LinkButton></td></tr>
        <tr><td></td></tr>
        <tr><td><asp:LinkButton ID="lnk2" runat="server" ForeColor="White" 
                onclick="lnk2_Click">Edit Profile</asp:LinkButton></td></tr>
        <tr><td></td></tr>
        <tr><td>
            <asp:LinkButton ID="lnk3" runat="server" ForeColor="White" onclick="lnk3_Click" 
                >Change Password</asp:LinkButton></td></tr>
        <tr><td></td></tr>
        <tr><td>
            <asp:LinkButton ID="lnk4" runat="server" ForeColor="White" onclick="lnk4_Click"
                >Connection</asp:LinkButton></td></tr>
        <tr><td></td></tr>
        <tr><td>
            <asp:LinkButton ID="lnk5" runat="server" ForeColor="White" onclick="lnk5_Click" 
                >Complaint</asp:LinkButton></td></tr>
        <tr><td></td></tr>
        <tr><td>
         <asp:LinkButton ID="lnk6" runat="server" ForeColor="White" onclick="lnk6_Click"
                >Logout</asp:LinkButton></td></tr>
        <tr><td></td></tr>
         </table>
        </div>
    </div>        
    ...
    <div style="background-color:White;color: #0000FF;width:83%;height:auto;margin-left:212px;position:absolute">
       <asp:MultiView ID="mvuser" runat="server" ActiveViewIndex="0">
            ...
            <asp:Button ID="btnimgcncl" runat="server" Text="Cancel" onclick="btnimgcncl_Click" UseSubmitBehavior="false"/>
            </td>
            </tr>
            <tr><td align="left">
                <asp:Button ID="btnimgtry" runat="server" Text="Try it!" onclick="btnimgtry_Click" UseSubmitBehavior="false" 
                    /><br />
                    <asp:Label ID="lblerr" runat="server" ForeColor="Red" Text="" Visible="false"></asp:Label>
                    </td></tr>
            <tr><td align="left">
                <asp:Button ID="btnimgsave" runat="server" Text="Save" onclick="btnimgsave_Click" UseSubmitBehavior="false" 
                    />
            </td></tr>
            </table>
            ...
            <tr><td>
                <asp:Button ID="btnupdt" runat="server" Text="Update" 
                    CssClass="styled-button-1" onclick="btnupdt_Click" OnClientClick="return profileval()"/></td><td></td>
                <td>
                    <asp:Button ID="btncncl" runat="server" Text="Cancel" 
                        CssClass="styled-button-1" onclick="btncncl_Click" UseSubmitBehavior="false"/></td></tr>
            </table>
            <br /><br />
            </div>
            </div>
            ...
            <tr><td>
             ...
             <tr>
                <td>
                    <asp:Button ID="btnsvpass" runat="server" Text="Save" onclick="btnsvpass_Click" 
                        /></td>
             </tr>
             <tr><td>
            ...
            <div style="text-align:center">
                <asp:Label ID="lblnodata" runat="server" Text="" ForeColor="Red" Font-Size="Larger"></asp:Label>
                <asp:FormView ID="FormView1" runat="server" AllowPaging="True" 
                    onpageindexchanging="FormView1_PageIndexChanging" Width="500px">
                <ItemTemplate>
                ...
                <tr><td>Address :</td>
                    <td><asp:TextBox ID="txtadd" runat="server" ReadOnly="true" TextMode="MultiLine" Text='<%# bind("con_add") %>'></asp:TextBox></td>
                </tr>
                <tr><td>Area :</td>
            ...
            <div style="text-align:center">
             <asp:Label ID="lblnodata1" runat="server" Text="" ForeColor="Red" Font-Size="Larger"></asp:Label>
                <asp:FormView ID="FormView2" runat="server" AllowPaging="True" 
                    onpageindexchanging="FormView2_PageIndexChanging" Width="500px">
                <ItemTemplate>
                <div align="left" style="text-align:right">
                <table>
